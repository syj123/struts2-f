...
public class MyFreemarkerResult extends StrutsResultSupport {

	private static final long serialVersionUID = -3778230771704661631L;
	private static final String TEMPLATE_ROOT = "/template/";

	private static final Logger LOG = LogManager.getLogger(MyFreemarkerResult.class);
	...
	private static final String PARENT_TEMPLATE_WRITER = MyFreemarkerResult.class.getName() + ".parentWriter";
	 ...
	 * <p>
	 * The template locationArg has already been interpolated for any variable
	 * substitutions
	 * </p>
	 * <p>
	 ...
	 *             in case of freemarker template errors
	 */
	public void doExecute(String locationArg, ActionInvocation invocation) throws IOException, TemplateException {
		...
		Template template = configuration.getTemplate(TEMPLATE_ROOT + locationArg, deduceLocale());
	 ...
	 * @throws TemplateException
	 *             in case of freemarker configuration errors
	 */
	 ...
	 *             in case of errors during creating the model
	 */
	 ...
	 * different behaviour,
	 *
	 * @return the locale from action if action implements the
	 *         {@link LocaleProvider}) or local from configuration
	 */
	...
	/**
	 * @return true write to the stream only when template processing completed
	 *         successfully (false by default)
	 */
